#include <iostream>
using namespace std;
void skim_efficiency()
{
   TFile *f1 = new TFile("~/B+2mu+nu_mu/20171004_B+2mu+nu_mu_1_recons.root");
   TFile *f2 = new TFile("~/B+2mu+nu_mu/20171004_B+2mu+nu_mu_2_skim.root");
   TTree *muon1;
   TTree *muon2;
   ...
   c1->SaveAs("~/B+2mu+nu_mu/plot/before_skim.eps");
   ...
   c2->SaveAs("~/B+2mu+nu_mu/plot/after_skim.eps");
