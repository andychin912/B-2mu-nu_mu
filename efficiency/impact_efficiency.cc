#include <iostream>
using namespace std;
void impact_efficiency()
{
   TFile *f1 = new TFile("~/B+2mu+nu_mu/20171004_B+2mu+nu_mu_2_skim.root");
   TFile *f2 = new TFile("~/B+2mu+nu_mu/20171011_B+2mu+nu_mu_2_impact.root");
   TTree *muon1;
   TTree *muon2;
   ...
   TH1F *h1=new TH1F("h1","",3000,2,5);
   TH1F *h2=new TH1F("h2","",3000,2,5);
   TH1F *h3=new TH1F("h3","",3000,2,5);
   TH1F *h4=new TH1F("h4","",3000,2,5);

   //apply cuts 
   muon1->Draw("B_mu_P>>h1","B_mu_mcErrors==0&&(B_mcErrors==8||B_mcErrors==1032)");
   muon1->Draw("B_mu_P>>h2");
   muon2->Draw("B_mu_P>>h3","B_mu_mcErrors==0&&(B_mcErrors==8||B_mcErrors==1032)");
   muon2->Draw("B_mu_P>>h4");
   ...
   c1->SaveAs("~/B+2mu+nu_mu/plot/before_impact.eps");
   ...
   c2->SaveAs("~/B+2mu+nu_mu/plot/after_impact.eps");
