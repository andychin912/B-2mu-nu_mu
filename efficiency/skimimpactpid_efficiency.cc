#include <iostream>
using namespace std;
void skimimpactpid_efficiency()
{
   TFile *f1 = new TFile("~/B+2mu+nu_mu/20171004_B+2mu+nu_mu_1_recons.root");
   TFile *f2 = new TFile("~/B+2mu+nu_mu/20171011_B+2mu+nu_mu_4_pid.root");
   TTree *muon1;
   TTree *muon2;
   ...
   c1->SaveAs("~/B+2mu+nu_mu/plot/before_skimimpactpid.eps");
   ...
   c2->SaveAs("~/B+2mu+nu_mu/plot/after_skimimpactpid.eps");
